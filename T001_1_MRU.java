...
public class T001_1_MRU {
	public static void main (String arg[]) {
		Scanner entrada=new Scanner(System.in);//se crea el objeto para poder ingresar datos del teclado 1
		Scanner entrada2=new Scanner(System.in);////se crea el objeto para poder ingresar datos del teclado 2
		...
		String Di2=entrada2.nextLine();//Unidad de la velocidad Km/m/cm
		...
		String Ti2=entrada2.nextLine();//Unidad de tiempo Hr, Min ó seg
		...
		String Ve2=entrada2.nextLine();//Unidad que tiene el objeto km/mts/cm
		System.out.println("introduce la unidad que deseas saber:");
		String Saber=entrada2.nextLine();
